...
import { ImportadorUFPR } from "./procesos-rie/ImportadorUFPR.js";
...
import { ImportadorSentinel } from "./procesos-sentinel/ImportadorSentinel.js";
...
class ZRepo2Plugin extends ZRepoPluginClient {
    ...
    constructor() {
        ...
        this.registerProcess(ImportadorUFPR);
        ...
        this.registerProcess(ImportadorSentinel);
